...
exports.sendContactEmail = async ({ name, to, message }) => {
  ...
  <html lang="en">
    ...
    <body>
      ...
      <img src="https://eaic.vercel.app/assets/ENSIAS_AI_Club_logo_white-cb86c93d.png" alt="ENSIAS AI Club logo light" width="100px"/>
      <p>Hi ${name},</p>
      <br />
  ...
  const mailOptionsToUser = {
    from: email,
    to: to,
    subject: "Thanks for contacting ENSIAS AI Club!",
    html: html,
  };
